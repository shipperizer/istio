...
HUB=docker.io/istio TAG=1.5.4 make -f Makefile.core.mk controller docker
...
# test code.
HUB="docker.io/istio" TAG="1.5.4" E2E_ARGS="--use_operator --use_local_cluster=true --test_logs_path=${ARTIFACTS}" make e2e_simple_noauth
popd
